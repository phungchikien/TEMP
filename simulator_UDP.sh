...
# =================================================================
#             UDP FLOOD FOR EDUCATIONAL PURPOSE
...
LOG_FILE="hping3_udp_flood_$(date +%Y%m%d_%H%M%S).log"
VERBOSE=true
...
main() {
    ...
    log "=== UDP FLOOD SIMULATOR WITH SAFE TC DETECTION ==="
...
if [[ "$1" == "-h" || "$1" == "--help" ]]; then
    echo "UDP Flood Simulator with Safe TC Detection"
