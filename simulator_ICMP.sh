...
# =================================================================
#             ICMP FLOOD FOR EDUCATIONAL PURPOSE
...
LOG_FILE="hping3_icmp_flood_$(date +%Y%m%d_%H%M%S).log"
VERBOSE=true
...
main() {
    ...
    log "=== ICMP FLOOD SIMULATOR WITH SAFE TC DETECTION ==="
...
if [[ "$1" == "-h" || "$1" == "--help" ]]; then
    echo "ICMP Flood Simulator with Safe TC Detection"
